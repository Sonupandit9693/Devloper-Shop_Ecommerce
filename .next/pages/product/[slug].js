...
const Post = ({addToCart}) => {
  ...
  const checkServiceabiliti = async()=>{
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce"  className="lg:w-1/2  lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/71pNnnaOIzS._AC_UL320_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Codswear</h2>
        ...
        <div className="pin mt-6 flex space-x-2 text-sm">
            <input onChange={onChangepin} className='px-2 border-2 border-gray-400 rounded-md 'placeholder='Enter your pindode' type="text" />
            <button onClick={checkServiceabiliti} className=' text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded'>Check</button>
        </div>
        {(!service && service != null) &&<div className='text-red-700 text-sm mt-3'>
            Sorroy! we do not deliver to this pincode yet
        </div>}
